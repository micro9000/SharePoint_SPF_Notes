...
export default class ProviderWebPartDemo extends React.Component<
  IProviderWebPartDemoProps,
  IProviderWebPartDemoState
> {
  ...
  constructor(
    props: IProviderWebPartDemoProps,
    state: IProviderWebPartDemoState
  ) {
    super(props);
